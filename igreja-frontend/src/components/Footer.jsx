    ...
    <footer className="bg-blue-950 text-white pt-16 pb-8 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          {/* COLUNA 4: PEDIDO DE ORAÇÃO / NEWSLETTER */}
          <div>
            <h4 className="font-bold mb-6 text-white uppercase text-xs tracking-widest">Oração</h4>
            <p className="text-xs text-blue-100/60 mb-4">Precisa de oração? Deixe seu contato e entraremos em um clamor por você.</p>
            <form className="space-y-2">
              ...
              />
              <button className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-2 rounded-lg text-xs transition-all">
                PEDIR ORAÇÃO
              </button>
            </form>
          </div>
